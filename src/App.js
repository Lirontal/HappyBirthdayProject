  ...
  const randomBalloons = (n = 50) => {
   // return;
    ...
    [...Array(n)].forEach((e, i) => {
      ...
      res.push(<img src={balloons[randomBalloonIndex]} alt="" />)
    })
    return res;
  }
  return (
    <div ref={el} className="App">
      <div className="container">
        ...
        <div className="six">
          <img src="images/reut.JPG" alt="" className="lydia-dp" data-node-name="imagePath" />
          <img src="images/hat.svg" alt="" className="hat" />
          <div className="wish">
